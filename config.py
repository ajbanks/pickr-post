...
class Config:
    ...
    TWITTER_OAUTH_TOKEN = environ.get("TWITTER_OAUTH_TOKEN")
    TWITTER_OAUTH_TOKEN_SECRET = environ.get("TWITTER_OAUTH_TOKEN_SECRET")
    ...
    CELERY = dict(
        ...
        beat_schedule={
            "task_update_reddit_every_morning": {
                ...
                "schedule": crontab(hour=2, minute=30),  # morning schedule
            },
